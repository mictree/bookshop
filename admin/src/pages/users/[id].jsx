      ...
      <div className="singleContainer">
        <div className="top">
          <div className="left">
            ...
            <div className="item">
              <img
                src={user?.avatarUrl || "https://images.pexels.com/photos/733872/pexels-photo-733872.jpeg?auto=compress&cs=tinysrgb&dpr=3&h=750&w=1260"}
                alt=""
                className="itemImg"
              />
              <div className="details">
                ...
                <div className="detailItem">
                  <span className="itemKey">Postcode:</span>
